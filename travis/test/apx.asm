...
testcase	{0x62, 0x44, 0xFD, 0x08, 0x66, 0x09},	{adcx r25, [r9]}	;r64 + r/m64
	; TODO: fix below - r16-r31 cause errors when specified in B4-B0 without explicit EVEX
...
; 	TODO: 0x6B IMUL should allow ZU and EVEX prefix with the 32 and 64 bit
; 	registers because the IMM is 8 bit long
...
testcase	{0xC4, 0xE1, 0xF8, 0x90, 0xCA},	{kmovd k1, k2}
testcase	{0xC4, 0xE1, 0xF9, 0x90, 0xCA},	{kmovq k1, k2}
testcase	{0xC5, 0xF9, 0x90, 0x0A},	{kmovb k1, [rdx]}
testcase	{0xC5, 0xF8, 0x90, 0x0A},	{kmovw k1, [rdx]}
testcase	{0xC4, 0xE1, 0xF8, 0x90, 0x0A},	{kmovd k1, [rdx]}
testcase	{0xC4, 0xE1, 0xF9, 0x90, 0x0A},	{kmovq k1, [rdx]}
; legacy - 0x91 variant
testcase	{0xC5, 0xF9, 0x91, 0x0A},	{kmovb [rdx], k1}
testcase	{0xC5, 0xF8, 0x91, 0x0A},	{kmovw [rdx], k1}
testcase	{0xC4, 0xE1, 0xF8, 0x91, 0x0A},	{kmovd [rdx], k1}
testcase	{0xC4, 0xE1, 0xF9, 0x91, 0x0A},	{kmovq [rdx], k1}
; legacy - 0x92 variant
...
; TODO: these two instructions below are favoring the VEX prefix for now well explained reason
; They work when adding the {evex} prefix explicitly.
