...
x86/insns.xda: $(srcdir)/x86/insns.dat $(srcdir)/x86/preinsns.pl $(DIRS)
...
nsis/version.nsh: $(srcdir)/version $(srcdir)/version.pl $(DIRS)
...
nsis/arch.nsh: $(srcdir)/nsis/getpearch.pl nasm$(X) $(DIRS)
