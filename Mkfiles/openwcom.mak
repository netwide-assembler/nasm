...
top_srcdir  = .
srcdir      = .
#VPATH       = $(srcdir)/asm;$(srcdir)/x86;$(srcdir)/x86;$(srcdir)/macros;$(srcdir)/output;$(srcdir)/lib;$(srcdir)/common;$(srcdir)/stdlib;$(srcdir)/nasmlib;$(srcdir)/disasm;$(srcdir)/zlib
VPATH       =
...
INTERNAL_CFLAGS = -I"$(srcdir)" -I. -I"$(srcdir)/include" -I"$(srcdir)/x86" -I"$(srcdir)/asm" -I"$(srcdir)/disasm" -I"$(srcdir)/output" -I"$(srcdir)/zlib"
